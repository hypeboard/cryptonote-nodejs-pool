...
var cryptoNightAlloy = multiHashing['cryptonight-alloy'];
// Set instance id
 ...
 * Miner
 **/
function Miner(id, login, pass, ip, port, workerName, startingDiff, noRetarget, pushMessage){
    this.id = id;
    this.login = login;
    this.pass = pass;
    this.ip = ip;
...
if (shareBuffer[0] >= 5) {
     // log('info',logSystem,'Block version 5 seen');
            hash = cryptoNightAlloy(convertedBlob);
        }
        else {
